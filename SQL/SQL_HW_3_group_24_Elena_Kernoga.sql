...
select employees.employee_name, salary.monthly_salary from employees
	inner join roles_employee on employees.id = roles_employee.employee_id 
	inner join roles on roles.id= roles_employee.role_id 
	inner join employee_salary on employees.id = employee_salary.salary_id
	inner join salary on salary.id = employee_salary.salary_id 
...
select avg(salary.monthly_salary) as average from salary
	inner join employee_salary on salary.id = employee_salary.salary_id 
	inner join roles_employee on employee_salary.employee_id = roles_employee.employee_id 
	inner join roles on roles.id = roles_employee.role_id 
where roles.role_name like '%Junior%';
...
select sum(salary.monthly_salary) as sum from salary
	inner join employee_salary on salary.id = employee_salary.salary_id 
	inner join roles_employee on employee_salary.employee_id = roles_employee.employee_id 
	inner join roles on roles.id = roles_employee.role_id 
...
select min(salary.monthly_salary) as min from salary
	inner join employee_salary on salary.id = employee_salary.salary_id 
	inner join roles_employee on employee_salary.employee_id = roles_employee.employee_id 
	inner join roles on roles.id = roles_employee.role_id 
where roles.role_name like '%QA%';
...
select max(salary.monthly_salary) as max from salary
	inner join employee_salary on salary.id = employee_salary.salary_id 
	inner join roles_employee on employee_salary.employee_id = roles_employee.employee_id 
	inner join roles on roles.id = roles_employee.role_id 
where roles.role_name like '%QA%';
...
select count(roles_employee.role_id) as count from roles_employee 
	inner join roles on roles.id = roles_employee.role_id 
where roles.role_name like '%QA%';
...
select count(roles_employee.role_id) as count from roles_employee 
	inner join roles on roles.id = roles_employee.role_id 
where roles.role_name like '%devel%';
